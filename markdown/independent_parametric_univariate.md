...
The exact and nonentral t-based Confidence Interval is calculated by transforming the lower and upper confidence limits of Cohens'd with the cumulative normal distribution:
$$LL = \frac{2\Phi_{d{upper}/2}-1}{\Phi_{d_upper/2}}$$
$$UL = \frac{2\Phi_{d_{lower}/2}-1}{\Phi_{d_lower/2}}$$
### Cohen's U2
