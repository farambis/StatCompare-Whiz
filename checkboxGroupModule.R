all_eff_sizes_displayed <- list(
  ...
  bonett_d_corr_dependent = html("Cohen's <em>d'<sub>corr</sub></em>"),
  ...
  robust_bonett_d_dependent = html("<em>d'</em><sub>R</sub> (robust Cohen's <em>d'</em>)"),
  ...
  bias_corrected_mahalanobis_d = html("bias-corrected Mahalanobis <em>D</em>"),
  H2 = html("<em>H</em><sub>2</sub>"),
  EPV2 = html("<em>EPV</em><sub>2</sub>"),
