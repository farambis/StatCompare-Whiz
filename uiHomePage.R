                  ...
                  <div class = home_page_accordion>
                    <div class = accordion_container>
                      ...
                      <div class = accordion_content>
                        ...
                        <p>Amongst all ES applicable for comparing two groups, Cohen's <em>d</em> has consistently been found to be the most frequently reported ES, if not the only one (e.g., Alhija & Levy, 2008; Fritz et al., 2012 a/b; Farmus et al., 2022). 
                          This prevalent use of Cohen's <em>d</em> is unsurprising for two reasons. Firstly, because Cohen's d is the ES primarily discussed in books on applied statistics (e.g., Cumming & Calin-Jageman, 2017; Field, 2017; Agresti, 2018). Secondly, since the formula for 
                          ...
                          those ES are reported that gain prominence due to their inclusion in relevant literature and can be easily computed based on their widely knwon formula and basic summary statistics. 
                        </p>
                        <p>
                          The dominance of Cohen's <em>d</em> can be viewed as suboptimal since it has been ciritised for being biased (especially in small samples), susceptible to outliers, and for having an inflated sampling error when its statistical assumptions are violated on the one hand (e.g., Algina, Keselman, & Penfield, 2005;
                          Hedges & Olkin, 1985) as well as for being too abstract to be readily understandable to audiences not well versed in statistics on the other (e.g., Hanel et al., 2018; McGraw & Wong, 1992). However, a plethora of ES for comparing two groups have emerged 
                          over the years&mdash;see the reviews of Goulet-Pelletier and Cousineau, 2018, Keselman et al., 2008, and Peng and Chen, 2014 as well as the relevant chapters in Ellis, 2010 and Grissom &Kim, 2012. Some of these measures are ubiased and/or more robust versions
                          of Cohen's <em>d</em>, such as Hedges' <em>g</em> or <em>d</em><sub>R</sub>, while others estimate completely different quantities said to be more readily understendable, such as the common language effect size (<em>CL</em>) or the measures of overlap between two groups (<em>OVL</em>). Yet most of these ES are not discussed in applied statistics textbooks and only a handful have 
                          ...
                          this software package currently (version 29) only offers Glass’ <em>d</em> and Hedges’ <em>g</em> besides Cohen’s <em>d</em>. Hence, this shiny app not only aims to inform about the multitude of ES that are suitable for comparing two groups but also allows users to compute these ES
                          and their CIs for raw and aggregate data.
                        </p>
                        <p>
                          The implemented ES are organised according to the research design they are applicable to. This organisation is reflected in the sidebar menu items of this app&mdash;<em>independent groups</em>, <em>dependent groups</em>, <em>mixed design</em>, and <em>multivariate</em>. A further distinction is made between parametric ES, i.e., those with assumptions regarding the shapes of the contrasted populations, and non-parametric ES, i.e., those without such assumptions. This is reflected in respective menu sub-items&mdash;<em>parametric</em> and <em>non-parametric</em>. Lastly, for parametric ES the user can either select whether they want to compute ES for raw data (see accepted file formats below) or for aggregate data (see exceptions below). As a consequence for each parametric menu sub-item there are an additional two sub-items&mdash;<em>raw data</em> and <em>aggregate data</em>
                        </p>
                        <p>
                          ...
                          The main panel consists of the <em>Data</em>, <em>Effect Size</em>, <em>Visualisation</em>, and <em>Documentation</em> tabs. The <em>Data</em> tab shows the uploaded data in a table as well as summary statistics of the selected variables whcih are relevant to the selected design.
                          The <em>Effect Size</em> tab displays the user-selected ES and their CIs in a table that can be downloaded as a CSV file as well as user-selected test statistics (TS) for certain research designs. The <em>Visualisation</em> tab allows the user to create plots of selected ES, which can be downloaded as PDF files. The <em>Documentation</em> panel contains background information on the ES offered including the formulas on which the calculations are based.
                          ...
                          <ul>
                            ...
                            <li>the recalculation of bootstrap CIs after input changes,</li>
                            <li>the failure of a search algorithm causing the computation of an approximation instead of the exact value (see the documentations of the variance ratio and the tail ratio)</li>
                          </ul>
                        </p>
                      </div>
                    </div>
